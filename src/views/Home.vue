<template>
  <div>
    ...
    <AboutMe class="py-5" id="about" ref="about" />
    <Skills class="py-5 bg-light" id="skills" ref="skills" />
    <Work class="py-5" id="work" ref="work" />
    <Contact class="py-5" id="contact" ref="contact" />
    <MyFooter />
  </div>
</template>
...
/* header {
  width: 100%;
  /* height: 100vh; 
  background: url("../assets/images/sky.jpg") no-repeat 50% 50%;
